"""
Django settings for bizventure_41092 project.
...
ROOT_URLCONF = 'bizventure_41092.urls'
...
WSGI_APPLICATION = 'bizventure_41092.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bizventure_41092 API",
    "DESCRIPTION": "API documentation for bizventure_41092 App",
    "VERSION": "v1",
}
